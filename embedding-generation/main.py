...
def main():
    ...
    if os.path.exists(df_path + "udemy_courses_cleansed.csv"):
        ...
        udemy_courses_df = cleanse_courses(df_path + "udemy_course_data_final.csv")
    ...
    palm_emb = PalmEmb(udemy_courses_df, roadmap_nodes_df, df_path)

    udemy_courses_df = palm_emb.generate_palm_embedding_courses()
    roadmap_nodes_df = palm_emb.generate_palm_embedding_roadmap()
